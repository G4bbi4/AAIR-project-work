...
if __name__ == "__main__":
    ...
    trainer = Trainer(g, c1=1, c2=1)
    print(f"Starting Centralized Training with c1={trainer.c1}, c2={trainer.c2}...")
    trainer.train(episodes = 350)
    #g.render()
    print(trainer.q_table)  # controlla se è tutta uguale/zero
    print(f"Epsilon finale: {trainer.epsilon:.16f}")  # dovrebbe essere vicino a 0
    ...
    while not done and steps < 5000:
        ...
        print(f"State: {state}")
        print(f"Steps: {steps}")
        #print(f"Q-values: {trainer.q_table[state]}")
        time.sleep(0.15)
