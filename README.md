...
In the reward shaping progress, a component has been added where agents getting closer to the targets recieve a positive reward while agents getting further from the targets recieve a negative one.
...
<p align="center">
<img src="img/15000_episodes_c1_101000_c2_202000_d1_250000_d2_250000.gif" width="500" alt="Agents moving in the grid in search of the objects">
</p>

At the end of multiple different trainings, where the optimal parameters have been applied, a local optimum has been found at exactly 23 steps.
...
Optimizing the behavior of the second agent is likely to result in faster convergence. An example could be assign a specific object to one target so that only that agents should pick it. That could force the real collaborative approach, avoiding the lazy behavior.
